...
reset:
    ...
    li      /* A COMPLETER */      /* $27 <= 64 K */
    mult    /* A COMPLETER */
    mflo    /* A COMPLETER */      /* $26 <= proc_id*64K */
    addu    /* A COMPLETER */      /* $26 <= (proc_id + 1)*64K */
    la      /* A COMPLETER */      /* $29 <= seg_stack_base */
    addu    /* A COMPLETER */      /* $29 <= seg_stack_base + (proc_id + 1)*64K */
